...
public class VerificationActivity extends Activity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private final String APPLICATION_KEY = "3717cd3c-27e0-4768-abe2-b7aba134a6e";
...
//        Parse.initialize(this,"123456abcd","Noe0sCX5AE4Ax82d4ldp2wGunJMgIy1iMw4bFliL");
        showProgress();
    ...
    void createVerification(String phoneNumber, String method, boolean skipPermissionCheck) {
        ...
        if (method.equalsIgnoreCase(SendVerificationActivity.SMS)) {
    ...
    void initiateVerification(boolean skipPermissionCheck) {
        ...
        if (intent != null) {
            String phoneNumber = intent.getStringExtra(SendVerificationActivity.INTENT_PHONENUMBER);
            String method = intent.getStringExtra(SendVerificationActivity.INTENT_METHOD);
...
/*
        ...
        String s = getIntent().getStringExtra(SendVerificationActivity.INTENT_COUNTRYISO);
        ...
        user.signUpInBackground(new SignUpCallback() {
            ...
            public void done(ParseException e) {
                if(e== null){
                    Intent intent=new Intent(VerificationActivity.this,EditNameAndImageFirst.class);
