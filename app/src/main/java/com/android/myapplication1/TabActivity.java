...
//            tabLayout.getTabAt(i).setIcon(R.drawable.tapp);
//        }

        tabLayout.getTabAt(0).setIcon(R.drawable.groupmember);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TabActivity.this,CreateGroupActivity.class);
